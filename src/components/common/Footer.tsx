...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0f1e2c] text-slate-300 pt-16 pb-8 border-t-4 border-[#E83E8C]">
            ...
            <div className="pt-3 flex items-center gap-3">
              {settings.socialLinks.facebook && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:text-white hover:bg-[#0E5D94] transition-colors"
                  aria-label="Facebook"
                >
                  f
                </a>
              ...
              {settings.socialLinks.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:text-white hover:bg-[#E83E8C] transition-colors"
              ...
              {settings.socialLinks.youtube && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:text-white hover:bg-red-600 transition-colors"
                  aria-label="YouTube"
                >
                  yt
                </a>
              ...
              {settings.socialLinks.linkedin && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:text-white hover:bg-blue-600 transition-colors"
                  aria-label="LinkedIn"
                >
                  in
                </a>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={item.path}>
                  <Link
                    to={item.path}
                    className="flex items-center gap-1.5 text-slate-400 hover:text-white hover:translate-x-1 transition-all"
                  >
              ...
              {footerServices.map((srv) => (
                <li key={srv.slug}>
                  <Link
                    ...
                    className="flex items-center gap-1.5 text-slate-400 hover:text-[#E83E8C] hover:translate-x-1 transition-all"
                  >
