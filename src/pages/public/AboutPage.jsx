...
import { ShieldCheck, Award, Target, Heart, ChevronRight, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
              <img src={homepage.aboutImageUrl || 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=800&q=80'} alt="Prisha IVF Lab" className="w-full h-[450px] object-cover"/>
            </div>
          </div>
        </div>
        ...
        <div className="pt-10 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {doctors.slice(0, 3).map((doc) => (<div key={doc.id} className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-xs p-6 flex flex-col justify-between">
        ...
        <div className="bg-gradient-prisha text-white rounded-3xl p-10 text-center space-y-4 shadow-xl">
          ...
          <div className="pt-3">
            <Link to="/appointment" className="px-8 py-3.5 rounded-full text-sm font-bold text-[#0E5D94] bg-white hover:bg-sky-50 shadow-md transition-all">
