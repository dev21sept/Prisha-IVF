...
export const AppointmentPage: React.FC = () => {
  ...
  const [preferredContactMethod, setPreferredContactMethod] = useState<'phone' | 'whatsapp' | 'email'>('phone');
  ...
  return (
    <div className="w-full bg-[#f8fbfe] py-12 lg:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-8 space-y-10">
        ...
        {/* Success Card */}
        {successAptId ? (
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-100 shadow-xl text-center space-y-6 animate-in fade-in duration-500">
            ...
            <div className="pt-4 flex justify-center gap-4">
              <Link
                to="/"
                className="px-6 py-2.5 rounded-full text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors"
              >
                Return to Homepage
              </Link>
              <button
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-100 shadow-xl space-y-8">
            {errorMsg && (
              <div className="flex items-center gap-2 p-4 rounded-xl bg-red-50 text-red-700 text-xs font-semibold border border-red-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:border-[#0E5D94] focus:ring-2 focus:ring-sky-100 outline-none transition-all"
                    />
                  </div>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:border-[#0E5D94] focus:ring-2 focus:ring-sky-100 outline-none transition-all bg-white"
                    >
                  ...
                  <div className="flex gap-4 text-xs font-semibold text-slate-700 pt-1">
                    <label className="flex items-center gap-1.5 cursor-pointer">
                      <input
                        ...
                        className="text-[#0E5D94] focus:ring-[#0E5D94]"
                      />
                    ...
                    <label className="flex items-center gap-1.5 cursor-pointer">
                      <input
                        ...
                        className="text-[#E83E8C] focus:ring-[#E83E8C]"
                      />
                      <span>Email</span>
                    </label>
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    rows={3}
                    placeholder="e.g. Trying to conceive for 3 years, past IUI/IVF cycles, PCOS or thyroid history..."
                    value={message}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 rounded-xl text-base font-bold text-white bg-gradient-to-r from-[#0E5D94] to-[#0A4D7A] hover:from-[#0a4975] hover:to-[#0E5D94] shadow-lg hover:shadow-xl transition-all disabled:opacity-50"
              >
