...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-[#f8fbfe] px-4 py-16">
      <div className="max-w-md w-full text-center space-y-6 bg-white p-8 sm:p-12 rounded-3xl border border-slate-100 shadow-xl">
        ...
        <div className="pt-2 flex flex-col gap-3">
          <Link
            to="/"
            className="w-full py-3 rounded-xl text-xs font-bold text-white bg-[#0E5D94] hover:bg-[#0a4975] transition-colors flex items-center justify-center gap-2 shadow-xs"
          >
          ...
          <Link
            to="/appointment"
            className="w-full py-3 rounded-xl text-xs font-bold text-[#0E5D94] bg-sky-50 hover:bg-sky-100 transition-colors flex items-center justify-center gap-2 border border-sky-100"
          >
