      ...
      {selectedApt && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-slate-200 space-y-6 animate-in zoom-in-95 duration-200">
            ...
            {selectedApt.message && (
              <div className="p-4 rounded-xl bg-sky-50 text-xs text-slate-700 border border-sky-100 space-y-1">
            ...
            <div className="space-y-2 text-xs">
              ...
              <textarea
                rows={3}
                placeholder="e.g. Called on 17 Sep. Confirmed 10:30 AM slot. Patient instructed to bring past semen reports."
                value={adminNotes}
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="px-4 py-1.5 rounded-lg text-xs font-bold text-white bg-[#0E5D94] hover:bg-[#0a4975] transition-colors"
                >
                  Save Internal Notes
                </button>
              </div>
