            ...
            <form onSubmit={handleSave} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={editingBlog.category || 'IVF & Treatments'}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 rounded-xl border border-slate-200 focus:border-[#0E5D94] outline-none font-mono"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="IVF, Embryology, Blastocyst, Implantation"
                  value={tagsText}
