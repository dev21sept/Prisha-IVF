      ...
      <div className="max-w-md w-full bg-white rounded-3xl p-8 sm:p-10 shadow-2xl relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          <Link to="/" className="inline-block">
            <img src={settings.logo || '/images/prisha-ivf-logo.png'} alt="Prisha IVF" className="h-12 w-auto mx-auto object-contain"/>
          </Link>
        ...
        <form onSubmit={handleLogin} className="space-y-4 text-sm">
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@prishaivf.in" className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:border-[#0E5D94] focus:ring-2 focus:ring-sky-100 outline-none transition-all"/>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••••••" className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:border-[#0E5D94] focus:ring-2 focus:ring-sky-100 outline-none transition-all"/>
            </div>
          </div>

          <button type="submit" disabled={loading} className="w-full py-3.5 rounded-xl font-bold text-white bg-gradient-to-r from-[#0E5D94] to-[#0A4D7A] hover:from-[#0a4975] hover:to-[#0E5D94] shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50">
        ...
        <div className="bg-sky-50 border border-sky-100 rounded-2xl p-4 text-xs text-slate-600 space-y-2">
          <div className="font-bold text-[#0E5D94] flex items-center justify-between">
            ...
            <button onClick={handleQuickFill} className="text-[11px] text-[#E83E8C] font-bold hover:underline">
              Auto-Fill
            </button>
          </div>
