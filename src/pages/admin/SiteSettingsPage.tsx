...
import { Save, CheckCircle, Settings, ShieldCheck, Globe, Phone, MapPin } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Mon - Sat: 08:30 AM - 08:00 PM"
                  className="w-full p-2.5 rounded-xl border border-slate-200 focus:border-[#0E5D94] outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="10:00 AM - 02:00 PM (Emergency & Scheduled)"
                  className="w-full p-2.5 rounded-xl border border-slate-200 focus:border-[#0E5D94] outline-none"
                />
              </div>
            </div>
