...
export const MediaManagerPage: React.FC = () => {
  ...
  const handleCopy = (id: string, textUrl: string) => {
            ...
            <div className="p-3.5 space-y-2">
              ...
              <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                <button
                  ...
                  className={`flex-1 py-1 px-2 rounded-lg text-[11px] font-bold flex items-center justify-center gap-1 transition-colors ${
                    copiedId === item.id ? 'bg-emerald-100 text-emerald-700' : 'bg-sky-50 text-[#0E5D94] hover:bg-sky-100'
                  }`}
                >
                  {copiedId === item.id ? (
                    <>
            ...
            <form onSubmit={handleAdd} className="space-y-3.5 text-xs">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. embryo-transfer-room.jpg"
                  value={name}
