      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="px-4 py-2 rounded-xl text-xs font-bold text-white bg-[#0E5D94] hover:bg-[#0a4975] shadow-xs transition-colors flex items-center gap-1.5"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
          <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            ...
            <Link
              to="/admin/appointments"
              className="text-xs font-bold text-[#0E5D94] hover:underline flex items-center gap-1"
            >
                  ...
                  <tr key={apt.id} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="p-3.5 text-right">
                      <select
                        ...
                        className="text-[11px] font-semibold border border-slate-200 rounded-lg p-1 bg-white focus:border-[#0E5D94] outline-none"
                      >
        ...
        <div className="lg:col-span-4 bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden flex flex-col justify-between">
          <div>
            ...
            <div className="divide-y divide-slate-100">
              {recentContacts.map((c) => (
                <div key={c.id} className="p-4 hover:bg-slate-50 transition-colors space-y-1.5">
                  <div className="flex items-center justify-between">
          ...
          <div className="p-4 border-t border-slate-100 bg-slate-50/50">
            <Link
              to="/admin/contacts"
              className="w-full block text-center py-2 text-xs font-bold text-[#0E5D94] hover:underline"
            >
              Open Contact Inbox →
            </Link>
          </div>
