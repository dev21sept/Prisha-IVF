...
import { Plus, Edit2, Trash2, Microscope, Search } from 'lucide-react';
            ...
            <form onSubmit={handleSave} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={editingService.category || 'Core ART'}
                    onChange={(e) => setEditingService({ ...editingService, category: e.target.value })}
                    className="w-full p-2.5 rounded-xl border border-slate-200 focus:border-[#0E5D94] outline-none bg-white"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Highest cumulative pregnancy rates&#10;Class 10,000 cleanroom culture&#10;Enables Day 5 blastocyst selection"
                  className="w-full p-2.5 rounded-xl border border-slate-200 focus:border-[#0E5D94] outline-none"
                />
              </div>
