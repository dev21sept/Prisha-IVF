...
const initialDoctors = [
  {
    ...
    fullBio: 'Dr. Radhika Sharma is the Medical Director at Prisha IVF. Having trained extensively in Germany and premier Indian medical institutions, she is widely recognized for her patient-centric protocols and exceptional success rates in patients with diminished ovarian reserve and advanced maternal age.',
  ...
  },
  {
    ...
    fullBio: 'Dr. Ananya Sen heads the embryology laboratories at Prisha IVF. A certified member of the European Society of Human Reproduction and Embryology (ESHRE), she brings unmatched precision to micromanipulation and laser-assisted hatching.',
  ...
  },
  {
    ...
    specialization: ['Azoospermia Treatment', 'Micro-TESE & TESA', 'Varicocele Micro-Surgery'],
    ...
    fullBio: 'Dr. Vikramaditya Rathore is a specialized male fertility microsurgeon with deep expertise in non-obstructive azoospermia and severe male factor infertility.',
  ...
  },
  {
    ...
    specialization: ['PCOS & Ovulatory Disorders', 'Recurrent Miscarriages', 'Pre-Conception Optimization'],
    ...
    fullBio: 'Dr. Meenakshi Joshi works closely with couples facing unexplained infertility and PCOS. She blends medical ovulation induction with nutritional balancing and psychological readiness.',
    image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=600&q=80',
    featured: false,
    published: true,
    displayOrder: 4,
  ...
  },
  {
    ...
    specialization: ['Minimally Invasive Fertility Surgery', 'Septum Resection & Asherman’s', 'Fibroid & Polyp Removal'],
    ...
    fullBio: 'Dr. Rajiv Oberoi ensures the uterine environment is anatomically optimized prior to embryo transfer using ultra-high-definition 4K hysteroscopy.',
  ...
  },
  {
    ...
    specialization: ['PGT-A / PGT-M Genetic Screening', 'Embryo Biopsy & Tubing', 'Carrier Genetic Screening'],
    ...
    fullBio: 'Dr. Priya Narang conducts Day-5 trophectoderm biopsies and interprets comprehensive Next-Generation Sequencing genetic data.',
    image: 'https://images.unsplash.com/photo-1594824813580-928929e06180?auto=format&fit=crop&w=600&q=80',
    featured: false,
    published: true,
    displayOrder: 6,
